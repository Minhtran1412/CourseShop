                            ...
                            <div class="bg-light rounded h-100 p-4">
                                ...
                                <form action="updateprofile" method="post">
                                    <div class="d-flex align-items-center mb-4">
                                        <img class="rounded-circle" src="${accprofile.getAccount_avatar()}" alt="" style="width: 80px; height: 80px;" id="image_preview">
                                        <input type="hidden" name="account_avatar_old" value="${accprofile.getAccount_avatar()}">
                                        <div class="ms-3">
                                            <h4>${accprofile.getAccount_name()}</h4>
                                            <c:if test="${accprofile.getAccount_role() == 0}">
                                                <span>Admin</span>
                                            </c:if>
                                            <c:if test="${accprofile.getAccount_role() != 0}">
                                                <span>Managementr</span>
                                    ...
                                    <c:if test="${account.getAccount_id() eq accprofile.getAccount_id()}">
                                        <input type="file" id="account_avatar" name="account_avatar" onchange="showImagePreview(this)" value="${accprofile.getAccount_avatar()}">
                                    </c:if>
                                    ...
                                    <div>
                                        <table class="table">
                                            <tbody>
                                                <tr>
                                                    <th>Account Name:</th>
                                                    <td>${accprofile.getAccount_name()}</td>
                                                </tr>

                                                <tr>
                                                    <th>Username:</th>
                                                    <td>${accprofile.getAccount_username()}</td>
                                                </tr>
                                                <tr>
                                                    <th>Role:</th>
                                                        <c:if test="${accprofile.getAccount_role() == 0}">
                                                ...
                                                <tr>
                                                    <th>Password:</th>
                                                        <c:if test="${account.getAccount_id() eq accprofile.getAccount_id()}">
                                                        <td>
                                                            <input type="text" name="account_password" value="${mode eq '1'? account_password : accprofile.getAccount_password()}">
                                                        </td>
                                                    </c:if>
                                                    <c:if test="${account.getAccount_id() ne accprofile.getAccount_id()}">
                                                        <td>
                                                            ${accprofile.getAccount_password()}
                                                        </td>
                                                    </c:if>
                                                </tr>
                                                <tr>
                                                    <th>Email:</th>
                                                        <c:if test="${account.getAccount_id() eq accprofile.getAccount_id()}">
                                                        <td>
                                                            <input type="text" name="account_email" value="${mode eq '1'? account_email : accprofile.getAccount_email()}">
                                                        </td>
                                                    </c:if>
                                                    <c:if test="${account.getAccount_id() ne accprofile.getAccount_id()}">
                                                        <td>
                                                            ${accprofile.getAccount_email()}
                                                        </td>
                                                    </c:if>
                                                ...
                                                <tr>
                                                    <th>Phone:</th>
                                                        <c:if test="${account.getAccount_id() eq accprofile.getAccount_id()}">
                                                        <td>
                                                            <input type="text" name="account_phone" value="${mode eq '1'? account_phone : accprofile.getAccount_phone()}">
                                                        </td>
                                                    </c:if>
                                                    <c:if test="${account.getAccount_id() ne accprofile.getAccount_id()}">
                                                        <td>
                                                            ${accprofile.getAccount_phone()}
                                                        </td>
                                                    </c:if>
