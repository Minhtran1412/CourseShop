 ...
 */
public class Course {
    private String course_id,course_name,course_description,course_price,course_create_date,course_modified_date,category_id,supplier_id,course_short_desc,course_create_by,course_modified_by,course_img,course_discount;

    public Course() {
    }

    public Course(String course_id, String course_name, String course_description, String course_price, String course_create_date, String course_modified_date, String category_id, String supplier_id, String course_short_desc, String course_create_by, String course_modified_by, String course_img, String course_discount) {
    ...
    public String getSupplier_name(){
        ...
        return sd.getSupplierByID(supplier_id).getSupplier_name();
    }
