...
public class CategoriesDAO extends DBContext {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(cd.getCategoryByName("java"));
        
    }

    public Categories getCategoryByName(String category_name) {
        try {
            String strSelect = "select * from Categories where category_name = ?";
            PreparedStatement st = connection.prepareStatement(strSelect);
            ...
            System.out.println("getCategoryIdByName" + e.getMessage());
        }
        return null;
    }
}
