<%-- 
    Document   : detail
    Created on : Mar 11, 2023, 5:35:36 PM
    Author     : acer
--%>
                ...
                <div class="container">
                    ...
                    <div class="col-md-5">
                        <div class="product-details">
                            ...
                            <div>
                                <fmt:formatNumber var="courseprice" value="${p.getCourse_price()}" type="currency" currencySymbol="₫" />
                                <h4 class="product-price">${courseprice}</h4><br/>
                            ...
                            <ul class="product-links">
                                <li>Category:</li>
                                <li><a href="#">${p.getCategory_name()}</a></li>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <c:forEach items="${requestScope.listP}" var="p">
                        <c:if test="${p.getCourse_id() != requestScope.course_id}">
                            <div class="col-md-3 col-xs-6">
                                <div class="product">
                                    <div class="product-img">
                                        <img src="./${p.getCourse_img()}" alt="">
                                        <div class="product-label">
                                            <span class="sale">-${p.getCourse_discount()}%</span>
                                        </div>
                                    </div>
                                    <div class="product-body" style="width: 262.5px; height: 133.4px">
                                        <p class="product-category">${p.getCategory_name()}</p>
                                        <h3 class="product-name"><a href="detail?id=${p.getCourse_id()}">${p.getCourse_name()}</a></h3>
                                            <fmt:formatNumber var="productprice" value="${p.getCourse_price()*(100-p.getCourse_discount())/100}" type="currency" currencySymbol="₫" />

                                        <h4 class="product-price">${productprice}
                                            <fmt:formatNumber var="productoldprice" value="${p.getCourse_price()}" type="currency" currencySymbol="₫" />
                                            <del class="product-old-price">${productoldprice}</del></h4><div class="product-rating">
                                        </div>
                                    </div>
                                    <div class="add-to-cart">
                                        <button class="add-to-cart-btn"><i class="fa fa-shopping-cart"></i> add to cart</button>
